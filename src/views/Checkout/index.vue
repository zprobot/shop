    ...
    <div class="xtx-pay-checkout-page">
        <div class="container">
            <div class="wrapper">
                ...
                <!-- 提交订单 -->
                <div class="submit">
                    <el-button type="primary" size="large" @click="getOrderId(checkInfo!.goods,curAddress!.id)">提交订单</el-button>
                </div>
            </div>
        </div>
    </div>
...
const { checkInfo, curAddress,activeAddress,switchAddress,updateAddress } = useCheckout()
